...
### **3. Run NMDS**
NMDS is performed on Bray–Curtis dissimilarities computed from Hellinger-transformed ASV abundance profiles.
```{r}
...
### **10. Perform ANOVA Welch test: MDS1**
...
### **11. Perform ANOVA Welch test: MDS2**
