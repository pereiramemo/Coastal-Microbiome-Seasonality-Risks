...
### **2. Load data**
`asvs_non_rare_long.tsv`: non-rarefied ASV abundance table (long format). 
`asvs_workable.tsv.gz`: rarefied ASV abundance table (wide format).  
`asv_table_nbcandem_annot_clean_long.tsv`: ASV abundance with taxonomic annotation (long format).  
...
ASV_ABUND_TBL <- read_tsv("../data/asvs/asvs_non_rare_long.tsv.gz", show_col_types = FALSE) 
ASV_TAXA_TBL <- read_tsv("../data/asvs/asv_table_nbcandem_annot_clean_long.tsv.gz", col_names = T, show_col_types = FALSE)
