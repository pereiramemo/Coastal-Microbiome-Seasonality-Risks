...
# Intro
Compares the functional diversity and richness between the communities associated to the 
semesters Summer-Autumn and Winter-Spring, to reproduce the analyses and the Figure 3B
...
### **2. Load data**
`opus_workable.tsv`: rarefied OPUs abundance table (wide format).  
...
### **6. Plot diversity and richness value distributions**
