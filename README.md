...
- `resources/custom_bray_curtis.R` – function to decompose the Bray–Curtis dissimilarity
- `resources/increasing_temp_simulation.R` – function to perform the increased-temperature simulation
- `resources/rare_indval.R` – function to run the IndVal analysis integrating the consistency score
